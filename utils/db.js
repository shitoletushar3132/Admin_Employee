...
const updateEmployee = (
  ...
  console.log("Gender:", gender); // Log gender for debugging

  const sql = `UPDATE employee SET name=?, email=?, mobile_no=?, designation=?, gender=?, course=?, img_path=?, created_date=NOW() WHERE id=?`;

  console.log("SQL:", sql); 
  console.log("Params:", [name, email, mobile_no, designation, gender, course, img_path || "https://th.bing.com/th/id/OIP.OsIQdMS0ffnElgj2IeFwtAHaHa?w=512&h=512&rs=1&pid=ImgDetMain", id]); // Log params for debugging
  ...
  const params = [
    ...
    gender,
    course,
    img_path || "https://th.bing.com/th/id/OIP.OsIQdMS0ffnElgj2IeFwtAHaHa?w=512&h=512&rs=1&pid=ImgDetMain",
    id,
  ];
